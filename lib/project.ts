...
`
const select = `SELECT ?project_code ?project_logo ?project_name ?project_uri (REPLACE(STR(?project_uri), "^.*/([^/]*)$", "$1") AS ?project_uuid)`
...
WHERE {
  GRAPH ?g {
    ...
    ?e42_code rdf:type crm:E42_Identifier .
    ?e42_code crm:P2_has_type iremus:574ffe9e-525c-42f2-8188-329ba3c7231d .
    ?e42_code crm:P190_has_symbolic_content "${code}" .
  }
}`)
