const pc = "http://data-iremus.huma-num.fr/id/d2a536eb-4a95-484f-b13d-f597ac8ea2fd", hc = "http://data-iremus.huma-num.fr/id/9d0388cb-a178-46b2-b047-b5a98f7bdf0b", mc = "http://data-iremus.huma-num.fr/id/689e148d-a97d-45b4-898d-c395a24884df", yc = "http://data-iremus.huma-num.fr/id/90a2ae1e-0fbc-4357-ac8a-b4b3f2a06e86", _c = "http://data-iremus.huma-num.fr/id/6d72746a-9f28-4739-8786-c6415d53c56d", gc = "http://data-iremus.huma-num.fr/id/bf9dce29-8123-4e8e-b24d-0c7f134bbc8e", bc = "http://data-iremus.huma-num.fr/id/29b00e39-75da-4945-b6c4-a0ca00f96f68", vc = "http://data-iremus.huma-num.fr/id/82dbd157-20df-422c-88db-28d6075d99a1", Ii = "http://data-iremus.huma-num.fr/id/21816195-6708-4bbd-a758-ee354bb84900", Ci = "http://data-iremus.huma-num.fr/id/cabe46bf-23d4-4392-aa20-b3eb21ad7dfd", Ec = (e) => `
...
const xi = "http://purl.org/ontology/bibo/", $i = "http://www.cidoc-crm.org/lrmoo/", Li = "http://www.cidoc-crm.org/cidoc-crm/", qi = "http://www.ics.forth.gr/isl/CRMdig/", Fi = "http://purl.org/dc/elements/1.1/", Mi = "http://purl.org/dc/terms/", Vi = "http://xmlns.com/foaf/0.1/", zi = "http://data-iremus.huma-num.fr/ns/hemef#", _e = "http://data-iremus.huma-num.fr/id/", Ui = "http://data-iremus.huma-num.fr/id/", Hi = "http://data-iremus.huma-num.fr/ns/", Qi = "http://data-iremus.huma-num.fr/graph/", Gi = "http://data-iremus.huma-num.fr/ns/musrad30#", Ki = "http://www.w3.org/2002/07/owl#", Bi = "http://www.w3.org/1999/02/22-rdf-syntax-ns#", Xi = "http://www.w3.org/2000/01/rdf-schema#", Wi = "http://schema.org/", Yi = "http://www.w3.org/2004/02/skos/core#", Ji = {
  [Li]: "crm",
  [qi]: "crmdig",
  [xi]: "bibo",
  [Fi]: "dc",
...
function aa(e, t, n, o) {
  ...
  if (_.forEach((P) => {
    o[P] = !0;
  }), !(n && n.type === He.REPLACE) && _.length > 0)
...
var dr = Symbol.for("immer-nothing"), Qe = Symbol.for("immer-draftable"), me = Symbol.for("immer-state"), Xn = process.env.NODE_ENV !== "production" ? [
...
function be(e) {
  var t;
  return e ? Wn(e) || Array.isArray(e) || !!e[Qe] || !!((t = e.constructor) != null && t[Qe]) || tt(e) || rt(e) : !1;
}
...
function la(e) {
  return ge(e) || ue(15, e), e[me].base_;
}
function Be(e, t) {
...
function tr(e) {
  rr(e), e.drafts_.forEach(ma), e.drafts_ = null;
}
function rr(e) {
  e === We && (We = e.parent_);
}
...
function pn(e, t) {
  ...
  const n = t.drafts_[0];
  return e !== void 0 && e !== n ? (n[me].modified_ && (tr(t), ue(4)), be(e) && (e = wt(t, e), t.parent_ || St(t, e)), t.patches_ && Ie("Patches").generateReplacementPatches_(
    n[me].base_,
    e,
    t.patches_,
    t.inversePatches_
...
var pr = {
  get(e, t) {
    ...
    if (!Xe(n, t))
      return _a(e, n, t);
    const o = n[t];
    return e.finalized_ || !be(o) ? o : o === Ut(e.base_, t) ? (Ht(e), e.copy_[t] = or(o, e)) : o;
  },
  has(e, t) {
    return t in Pe(e);
  },
  ...
  set(e, t, n) {
    ...
    if (!e.modified_) {
      const i = Ut(Pe(e), t), f = i == null ? void 0 : i[me];
      if (f && f.base_ === n)
  ...
  deleteProperty(e, t) {
    return Ut(e.base_, t) !== void 0 || t in e.base_ ? (e.assigned_[t] = !1, Ht(e), nr(e)) : delete e.assigned_[t], e.copy_ && delete e.copy_[t], !0;
  },
...
var ga = class {
  ...
  createDraft(e) {
    ...
    return n[me].isManual_ = !0, rr(t), n;
  }
  finishDraft(e, t) {
    const n = e && e[me];
    (!n || !n.isManual_) && ue(9);
...
function or(e, t) {
  const n = tt(e) ? Ie("MapSet").proxyMap_(e, t) : rt(e) ? Ie("MapSet").proxySet_(e, t) : ya(e, t);
...
function ba() {
  ...
  function f(d, c, p, h) {
    ...
    Be(d.assigned_, (b, s) => {
      const l = zt(O, b), u = zt(E, b), m = s ? Xe(O, b) ? e : t : n;
      if (l === u && m === e)
        return;
      const v = c.concat(b);
      p.push(m === n ? { op: m, path: v } : { op: m, path: v, value: u }), h.push(
        m === t ? { op: n, path: v } : m === n ? { op: t, path: v, value: w(l) } : { op: e, path: v, value: w(l) }
      );
    });
  }
  function _(d, c, p, h) {
  ...
  function g(d, c) {
    return c.forEach((p) => {
      ...
      for (let u = 0; u < h.length - 1; u++) {
        const m = Ae(E);
        let v = h[u];
        typeof v != "string" && typeof v != "number" && (v = "" + v), (m === 0 || m === 1) && (v === "__proto__" || v === "constructor") && ue(19), typeof E == "function" && v === "prototype" && ue(19), E = zt(E, v), typeof E != "object" && ue(18, h.join("/"));
      }
...
var ye = new ga(), nt = ye.produce, ro = ye.produceWithPatches.bind(
  ye
);
ye.setAutoFreeze.bind(ye);
ye.setUseStrictShallowCopy.bind(ye);
var mn = ye.applyPatches.bind(ye);
...
function no(e, ...t) {
  const n = typeof e == "function" ? {
    ...
    const w = {
      ...
      devModeChecks: O = {}
    } = w, E = yn(c), b = yn(h), s = Pa(i), l = d(function() {
      return f++, T.apply(
        null,
        arguments
      );
...
var $a = "ModuleSymbhasOwnPr-0123456789ABCDEFGHNRVfgctiUvz_KqYTJkLxpZXIjQW", mr = (e = 21) => {
  let t = "", n = e;
  for (; n--; )
...
var La = ["name", "message", "stack", "code"], Qt = class {
  constructor(e, t) {
  ...
  function e(t, n, o) {
    ...
    function P(g) {
      return (T, w, d) => {
        const c = o != null && o.idGenerator ? o.idGenerator(g) : mr(), p = new AbortController();
        let h, O;
        function E(s) {
          O = s, p.abort();
        }
        const b = async function() {
          ...
          let u;
          try {
            let m = (s = o == null ? void 0 : o.condition) == null ? void 0 : s.call(o, g, {
              getState: w,
              extra: d
            });
            if (Ma(m) && (m = await m), m === !1 || p.signal.aborted)
              throw {
                name: "ConditionError",
            ...
            T(f(c, g, (l = o == null ? void 0 : o.getPendingMeta) == null ? void 0 : l.call(o, {
              ...
              signal: p.signal,
              abort: E,
              rejectWithValue: (S, A) => new Qt(S, A),
            ...
            u = m instanceof Qt ? _(null, c, g, m.payload, m.meta) : _(m, c, g);
          } finally {
...
function Ua({
  ...
  return function(o) {
    ...
    const _ = (typeof o.reducers == "function" ? o.reducers(Qa()) : o.reducers) || {}, P = Object.keys(_), g = {
    ...
    function w() {
      ...
      const [s = {}, l = [], u = void 0] = typeof o.extraReducers == "function" ? oo(o.extraReducers) : [o.extraReducers], m = {
        ...s,
...
function ls({
  ...
  return typeof fetch > "u" && n === Rn && console.warn("Warning: `fetch` is not available. Please supply a custom `fetchFn` property to use `fetchBaseQuery` on SSR environments."), async (c, p) => {
    ...
    if (!j.headers.has("content-type") && F(j.body) && j.headers.set("content-type", f), F(j.body) && i(j.headers) && (j.body = JSON.stringify(j.body, _)), S) {
      const I = ~m.indexOf("?") ? "&" : "?", M = o ? o(S) : new URLSearchParams(Pn(S));
      m += I + M;
    }
    m = is(e, m);
    const V = new Request(m, j);
    u = {
      request: new Request(m, j)
    };
    let L, H = !1, $ = C && setTimeout(() => {
      H = !0, p.abort();
    }, C);
    try {
      L = await n(V);
...
function hs({
  ...
  function w(b, s) {
    return (l) => {
      var u;
      const m = i.endpointDefinitions[b], v = e({
        queryArgs: s,
...
You must add the middleware for RTK-Query to function correctly!`);
  ...
  function O(b, s) {
    const l = (u, {
      ...
      const F = e({
        ...
        queryCacheKey: F,
        [Ze]: A
      }), L = o.endpoints[b].select(u), H = C(V), $ = L(x());
      h(C);
      const {
        requestId: K,
        abort: oe
      } = H, y = $.requestId !== K, I = (j = f.get(C)) == null ? void 0 : j[F], M = () => L(x()), B = Object.assign(A ? (
  ...
  function E(b) {
    return (s, {
      ...
      return _.set(m, L), L[D] = V, V.then(() => {
        delete L[D], $e(L) || _.delete(m);
      }), u && (L[u] = V, V.then(() => {
        L[u] === V && (delete L[u], $e(L) || _.delete(m));
      })), V;
    };
  }
}
...
function ms({
  ...
  const _ = (s, l, u, m) => (v, S) => {
    ...
    let D = {
      patches: [],
      inversePatches: [],
      undo: () => v(i.util.patchQueryData(s, l, D.inversePatches, m))
    };
    ...
    return v(i.util.patchQueryData(s, l, D.patches, m)), D;
  }, g = (s, l, u) => (m) => m(i.endpoints[s].initiate(l, {
    subscribe: !1,
    forceRefetch: !0,
    [Ze]: () => ({
      data: u
    ...
    try {
      ...
      if (V ? j = V() : C.query ? (j = await t(C.query(s.originalArgs), F, C.extraOptions), C.transformResponse && (x = C.transformResponse)) : j = await C.queryFn(s.originalArgs, F, C.extraOptions, (L) => t(L, F, C.extraOptions)), typeof process < "u" && process.env.NODE_ENV === "development") {
        ...
        let H;
        if (!j)
          H = `${L} did not return anything.`;
        else if (typeof j != "object")
          H = `${L} did not return an object.`;
        else if (j.error && j.data)
          H = `${L} returned an object containing both \`error\` and \`result\`.`;
        else if (j.error === void 0 && j.data === void 0)
          H = `${L} returned an object containing neither a valid \`error\` and \`result\`. At least one of them should not be \`undefined\``;
        else
          for (const $ of Object.keys(j))
            if ($ !== "error" && $ !== "data" && $ !== "meta") {
              H = `The object returned by ${L} has the unknown property ${$}.`;
              break;
            }
        H && console.error(`Error encountered handling the endpoint ${s.endpointName}.
              ${H}
      ...
      if (j instanceof Tn) {
        ...
        try {
          return m(await F(j.value, j.meta, s.originalArgs), {
            baseQueryMeta: j.meta,
            [Ue]: !0
          });
        } catch (V) {
...
In the case of an unhandled error, no tags will be "provided" or "invalidated".`, j) : console.error(j), j;
  ...
  function w(s, l) {
    var u, m, v;
    const S = (m = (u = l[e]) == null ? void 0 : u.queries) == null ? void 0 : m[s.queryCacheKey], A = (v = l[e]) == null ? void 0 : v.config.refetchOnMountOrArgChange, D = S == null ? void 0 : S.fulfilledTimeStamp, C = s.forceRefetch ?? (s.subscribe && A);
  ...
  const d = On(`${e}/executeQuery`, T, {
    ...
    condition(s, {
      ...
      var u, m, v;
      const S = l(), A = (m = (u = S[e]) == null ? void 0 : u.queries) == null ? void 0 : m[s.queryCacheKey], D = A == null ? void 0 : A.fulfilledTimeStamp, C = s.originalArgs, x = A == null ? void 0 : A.originalArgs, j = n[s.endpointName];
  ...
  }), p = (s) => "force" in s, h = (s) => "ifOlderThan" in s, O = (s, l, u) => (m, v) => {
    ...
    if (S)
      ...
      (Number(/* @__PURE__ */ new Date()) - Number(new Date(x))) / 1e3 >= A && m(D());
    } else
      m(D(!1));
  };
  function E(s) {
    return (l) => {
      var u, m;
      return ((m = (u = l == null ? void 0 : l.meta) == null ? void 0 : u.arg) == null ? void 0 : m.endpointName) === s;
    };
  }
  function b(s, l) {
    return {
      matchPending: Ge(yr(s), E(l)),
...
function ys({
  ...
  const T = he(`${e}/resetApiState`), w = xe({
      ...
      l.addCase(t.pending, (u, {
        ...
        u[S = v.queryCacheKey] ?? (u[S] = {
          ...
          D.status = "pending", D.requestId = A && D.requestId ? (
            ...
            m.requestId
          ), v.originalArgs !== void 0 && (D.originalArgs = v.originalArgs), D.startedTimeStamp = m.startedTimeStamp;
        });
      }).addCase(t.fulfilled, (u, {
        meta: m,
        payload: v
      }) => {
        gt(u, m.arg.queryCacheKey, (S) => {
          if (S.requestId !== m.requestId && !sr(m.arg))
            return;
          const {
            merge: A
          } = o[m.arg.endpointName];
          if (S.status = "fulfilled", A)
            ...
            S.data = o[m.arg.endpointName].structuralSharing ?? !0 ? so(ge(S.data) ? la(S.data) : S.data, v) : v;
          delete S.error, S.fulfilledTimeStamp = m.fulfilledTimeStamp;
        });
    ...
    extraReducers(l) {
      l.addCase(n.pending, (u, {
        ...
        v.arg.track && In(u, v, (S) => {
          S.requestId === v.requestId && (S.status = "fulfilled", S.data = m, S.fulfilledTimeStamp = v.fulfilledTimeStamp);
        });
        ...
        S.arg.track && In(u, S, (A) => {
          A.requestId === S.requestId && (A.status = "rejected", A.error = m ?? v);
        });
      }).addMatcher(_, (u, m) => {
        const {
          mutations: v
      ...
      updateProvidedBy: {
        reducer(l, u) {
          ...
          for (const {
            ...
            const x = (m = l[D] ?? (l[D] = {}))[v = C || "__internal_without_id"] ?? (m[v] = []);
    ...
    extraReducers(l) {
      ...
      }).addMatcher(Se(Re(t), Tt(t)), (u, m) => {
        const v = fo(m, "providesTags", o, P), {
          queryCacheKey: S
        } = m.meta.arg;
...
var vs = 2147483647 / 1e3 - 1, Es = ({
  ...
  function O(E, b) {
    ...
    if (c = [], u.length === 0)
      return;
    const m = f.util.selectInvalidatedBy(s, u);
    t.batch(() => {
  ...
  const i = yr(n, o), f = Le(n, o), _ = Re(n, o), P = {};
  return (g, T) => {
    var w, d;
    if (i(g)) {
      const {
      ...
      if (E) {
        ...
        const l = e.endpoints[p].select(O.type === "query" ? h : c), u = T.dispatch((v, S, A) => A), m = {
          ...T,
    ...
    middleware: (w) => {
      ...
      return (E) => (b) => {
        ...
        const s = {
          ...w,
          next: E
        }, l = w.getState(), [u, m] = h(b, s, l);
        let v;
        if (u ? v = E(b) : v = m, w.getState()[t] && (O(b, s, l), P(b) || i.hasRehydrationInfo(b)))
          for (let S of p)
            S(b, s, l);
        return v;
      };
  ...
  init(t, {
    ...
    return we(t.util, {
      ...
      injectEndpoint(K, oe) {
        var y;
        const I = t;
        (y = I.endpoints)[K] ?? (y[K] = {}), lo(oe) ? we(I.endpoints[K], {
          name: K,
          select: A(K, oe),
          initiate: j(K, oe)
...
function ks() {
  ...
  function E(y, I, M) {
    this.props = y, this.context = I, this.refs = O, this.updater = M || p;
  }
  E.prototype.isReactComponent = {}, E.prototype.setState = function(y, I) {
  ...
  var u = Array.isArray, m = Object.prototype.hasOwnProperty, v = { current: null }, S = { key: !0, ref: !0, __self: !0, __source: !0 };
  function A(y, I, M) {
    var B, z = {}, Z = null, se = null;
    if (I != null)
      for (B in I.ref !== void 0 && (se = I.ref), I.key !== void 0 && (Z = "" + I.key), I)
        m.call(I, B) && !S.hasOwnProperty(B) && (z[B] = I[B]);
    ...
    if (y && y.defaultProps)
      for (B in ee = y.defaultProps, ee)
        z[B] === void 0 && (z[B] = ee[B]);
    return { $$typeof: e, type: y, key: Z, ref: se, props: z, _owner: v.current };
  }
  function D(y, I) {
    return { $$typeof: e, type: y.type, key: I, ref: y.ref, props: y.props, _owner: y._owner };
  }
  function C(y) {
  ...
  var j = /\/+/g;
  function F(y, I) {
    return typeof y == "object" && y !== null && y.key != null ? x("" + y.key) : I.toString(36);
  }
  function V(y, I, M, B, z) {
    var Z = typeof y;
    ...
    if (se)
      return se = y, z = z(se), y = B === "" ? "." + F(se, 0) : B, u(z) ? (M = "", y != null && (M = y.replace(j, "$&/") + "/"), V(z, I, M, "", function(fe) {
        return fe;
      })) : z != null && (C(z) && (z = D(z, M + (!z.key || se && se.key === z.key ? "" : ("" + z.key).replace(j, "$&/") + "/") + y)), I.push(z)), 1;
    if (se = 0, B = B === "" ? "." : B + ":", u(y))
    ...
    else if (te = c(y), typeof te == "function")
      for (y = te.call(y), ee = 0; !(Z = y.next()).done; )
  ...
  return X.Children = { map: L, forEach: function(y, I, M) {
    L(y, function() {
    ...
    return y;
  } }, X.Component = E, X.Fragment = n, X.Profiler = i, X.PureComponent = s, X.StrictMode = o, X.Suspense = g, X.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = oe, X.cloneElement = function(y, I, M) {
    if (y == null)
      throw Error("React.cloneElement(...): The argument must be a React element, but you passed " + y + ".");
    var B = h({}, y.props), z = y.key, Z = y.ref, se = y._owner;
    if (I != null) {
      if (I.ref !== void 0 && (Z = I.ref, se = v.current), I.key !== void 0 && (z = "" + I.key), y.type && y.type.defaultProps)
        var ee = y.type.defaultProps;
      for (te in I)
        m.call(I, te) && !S.hasOwnProperty(te) && (B[te] = I[te] === void 0 && ee !== void 0 ? ee[te] : I[te]);
    }
    ...
    return { $$typeof: e, type: y.type, key: z, ref: Z, props: B, _owner: se };
  }, X.createContext = function(y) {
    return y = { $$typeof: _, _currentValue: y, _currentValue2: y, _threadCount: 0, Provider: null, Consumer: null, _defaultValue: null, _globalName: null }, y.Provider = { $$typeof: f, _context: y }, y.Consumer = y;
  }, X.createElement = A, X.createFactory = function(y) {
    var I = A.bind(null, y);
    return I.type = y, I;
  ...
  }, X.isValidElement = C, X.lazy = function(y) {
    return { $$typeof: w, _payload: { _status: -1, _result: y }, _init: H };
  }, X.memo = function(y, I) {
    return { $$typeof: T, type: y, compare: I === void 0 ? null : I };
  ...
  }, X.useCallback = function(y, I) {
    return $.current.useCallback(y, I);
  }, X.useContext = function(y) {
    return $.current.useContext(y);
  }, X.useDebugValue = function() {
  }, X.useDeferredValue = function(y) {
    return $.current.useDeferredValue(y);
  }, X.useEffect = function(y, I) {
    return $.current.useEffect(y, I);
  }, X.useId = function() {
    return $.current.useId();
  }, X.useImperativeHandle = function(y, I, M) {
    return $.current.useImperativeHandle(y, I, M);
  }, X.useInsertionEffect = function(y, I) {
    return $.current.useInsertionEffect(y, I);
  }, X.useLayoutEffect = function(y, I) {
    return $.current.useLayoutEffect(y, I);
  }, X.useMemo = function(y, I) {
    return $.current.useMemo(y, I);
  }, X.useReducer = function(y, I, M) {
    return $.current.useReducer(y, I, M);
  }, X.useRef = function(y) {
    return $.current.useRef(y);
  }, X.useState = function(y) {
    return $.current.useState(y);
  }, X.useSyncExternalStore = function(y, I, M) {
    return $.current.useSyncExternalStore(y, I, M);
...
function js() {
  return Ln || (Ln = 1, function(e, t) {
    process.env.NODE_ENV !== "production" && function() {
      ...
      L.ReactDebugCurrentFrame = S, L.ReactCurrentActQueue = m;
      function H(r) {
        {
      ...
      };
      {
        var Z = {
          ...
          Object.defineProperty(z.prototype, r, {
            get: function() {
              H("%s(...) is deprecated in plain JavaScript React classes. %s", a[0], a[1]);
            }
          });
        };
        for (var ee in Z)
      ...
      function Co(r, a, R) {
        var N, k = {}, U = null, q = null, Q = null, W = null;
        if (a != null) {
          Ir(a) && (q = a.ref, Io(a)), Cr(a) && (at(a.key), U = "" + a.key), Q = a.__self === void 0 ? null : a.__self, W = a.__source === void 0 ? null : a.__source;
          for (N in a)
        ...
        return It(r, U, q, Q, W, v.current, k);
      }
      function ko(r, a) {
      ...
      function jo(r, a, R) {
        ...
        var N, k = M({}, r.props), U = r.key, q = r.ref, Q = r._self, W = r._source, Y = r._owner;
        if (a != null) {
      ...
      function st(r, a, R, N, k) {
        ...
        if (q) {
          ...
          if (it(W)) {
            ...
            W != null && (ke(W) && (W.key && (!Q || Q.key !== W.key) && at(W.key), W = ko(
              W,
        ...
        if (it(r))
          for (var mt = 0; mt < r.length; mt++)
            ne = r[mt], ie = le + Ct(ne, mt), ce += st(ne, a, R, ie, k);
        else {
          var Mt = s(r);
          if (typeof Mt == "function") {
            var on = r;
            Mt === on.entries && (jr || H("Using Maps as children is not supported. Use an array of keyed ReactElements instead."), jr = !0);
        ...
        var R = !1, N = !1, k = !1;
        {
          ...
          Object.defineProperties(U, {
            ...
            displayName: {
              ...
              set: function(q) {
                k || (H("Setting `displayName` on Context.Consumer has no effect. You should set it directly on the context with Context.displayName = '%s'.", q), k = !0);
              }
            }
          }), a.Consumer = U;
        }
...
See https://reactjs.org/link/invalid-hook-call for tips about how to debug and fix this problem.`), r;
      ...
      function ci() {
        {
          if (Me === 0) {
            qr = console.log, Fr = console.info, Mr = console.warn, Vr = console.error, zr = console.group, Ur = console.groupCollapsed, Hr = console.groupEnd;
            var r = {
              configurable: !0,
              enumerable: !0,
              value: Qr,
      ...
      function Gr(r, a) {
        ...
        try {
          ...
          if (le && N && typeof le.stack == "string") {
            for (var Q = le.stack.split(`
`), W = N.stack.split(`
`), Y = Q.length - 1, re = W.length - 1; Y >= 1 && re >= 0 && Q[Y] !== W[re]; )
              re--;
            for (; Y >= 1 && re >= 0; Y--, re--)
              if (Q[Y] !== W[re]) {
                if (Y !== 1 || re !== 1)
                  do
                    if (Y--, re--, re < 0 || Q[Y] !== W[re]) {
                      var ne = `
          ...
          for (var q in r)
            if (U(r, q)) {
              ...
              try {
                ...
                Q = r[q](a, q, N, R, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
              } catch (Y) {
                Q = Y;
              }
              Q && !(Q instanceof Error) && (ft(k), $("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", N || "React class", R, q, typeof Q), ft(null)), Q instanceof Error && !(Q.message in Kr) && (Kr[Q.message] = !0, ft(k), $("Failed %s type: %s", R, Q.message), ft(null));
            }
        }
      }
      function je(r) {
...
Check the top-level render call using <` + R + ">.");
      ...
      function en(r, a, R) {
        ...
        var Q = Co.apply(this, arguments);
        if (Q == null)
          return Q;
        if (N)
          for (var W = 2; W < arguments.length; W++)
            Jr(arguments[W], r);
        return r === f ? _i(Q) : Zr(Q), Q;
      }
      var tn = !1;
      function gi(r) {
        var a = en.bind(null, r);
        return a.type = r, tn || (tn = !0, H("React.createFactory() is deprecated and will be removed in a future major release. Consider using JSX or use React.createElement() directly instead.")), Object.defineProperty(a, "type", {
          enumerable: !1,
          get: function() {
            return H("Factory.type is deprecated. Access the class directly before passing it to createFactory."), Object.defineProperty(this, "type", {
              value: r
            }), r;
          }
        }), a;
      ...
      function vi(r, a) {
        ...
        try {
          ...
          if (u.transition = R, R === null && N._updatedFibers) {
            ...
            k > 10 && H("Detected a large number of updates inside startTransition. If this is due to a subscription please re-write it to use React provided hooks. Otherwise concurrent mode guarantees are off the table."), N._updatedFibers.clear();
          }
        }
      }
      var rn = !1, pt = null;
      ...
      function Oi(r) {
        {
          var a = De;
          De++, m.current === null && (m.current = []);
          var R = m.isBatchingLegacy, N;
          try {
            if (m.isBatchingLegacy = !0, N = r(), !R && m.didScheduleLegacyUpdate) {
              var k = m.current;
              k !== null && (m.didScheduleLegacyUpdate = !1, Ft(k));
            }
          } catch (ie) {
            throw ht(a), ie;
          } finally {
            m.isBatchingLegacy = R;
          }
          if (N !== null && typeof N == "object" && typeof N.then == "function") {
            ...
            if (ht(a), De === 0) {
              var Y = m.current;
              Y !== null && (Ft(Y), m.current = null);
              var re = {
                then: function(ie, ce) {
                  m.current === null ? (m.current = [], Lt(W, ie, ce)) : ie(W);
                }
              };
              return re;
            } else {
      ...
      function Lt(r, a, R) {
        {
          ...
          if (N !== null)
            try {
              Ft(N), Ei(function() {
                N.length === 0 ? (m.current = null, a(r)) : Lt(r, a, R);
              });
            } catch (k) {
              R(k);
            }
...
function Ds() {
  ...
  return Gt.useSyncExternalStoreWithSelector = function(g, T, w, d, c) {
    ...
    p = _(function() {
      function E(m) {
        if (!b) {
          if (b = !0, s = m, m = d(m), c !== void 0 && h.hasValue) {
            var v = h.value;
            if (c(v, m))
              return l = v;
          }
        ...
        if (v = l, n(s, m))
          return v;
        var S = d(m);
        return c !== void 0 && c(v, S) ? v : (s = m, l = S);
      }
      ...
      var E = _(function() {
        var u = !1, m, v, S = function(x) {
          ...
          if (n(V, x))
            return L;
          var H = c(x);
          return p !== void 0 && p(L, H) ? L : (m = x, v = H, H);
...
var mo = /* @__PURE__ */ Er(), yo = qs, Fs = (e) => {
  yo = e;
}, Ms = (e, t) => e === t;
function Vs(e = Ce) {
  const t = e === Ce ? mo : Er(e), n = (o, i = {}) => {
...
Hs ? ve.useLayoutEffect : ve.useEffect;
function Hn(e, t) {
...
function Ke(e, t) {
  ...
  for (let i = 0; i < n.length; i++)
    if (!Object.prototype.hasOwnProperty.call(t, n[i]) || !Hn(e[n[i]], t[n[i]]))
      return !1;
  return !0;
}
function _o(e = Ce) {
...
function Zs({
  ...
  function w(h, O, E) {
    ...
    b === void 0 && (b = h.data);
    const s = b !== void 0, l = h.isLoading, u = !s && l, m = h.isSuccess || l && s;
    return {
      ...h,
      data: b,
      currentData: h.data,
  ...
  function c(h) {
    const O = (s, {
      ...
      if (!x.current) {
        const y = C(e.internalActions.internal_getRTKQSubscriptions());
    ...
    You must add the middleware for RTK-Query to function correctly!`);
      ...
      H && $ && (K = x.current.isRequestSubscribed(H, $));
      ...
      return T(() => {
        ...
        const M = (y = L.current) == null ? void 0 : y.subscriptionOptions;
        if (!I || I.arg !== j) {
      ...
      }, [C, D, m, j, F, oe]), G.useEffect(() => () => {
        var y;
        (y = L.current) == null || y.unsubscribe(), L.current = void 0;
      }, []), G.useMemo(() => ({
        /**
        ...
        refetch: () => {
          ...
          return (y = L.current) == null ? void 0 : y.refetch();
        }
      }), []);
    }, E = ({
      ...
      T(() => {
        var V, L;
        const H = (V = C.current) == null ? void 0 : V.subscriptionOptions;
        x !== H && ((L = C.current) == null || L.updateSubscriptionOptions(x));
      }, [x]);
      const j = G.useRef(x);
      T(() => {
        j.current = x;
      ...
      const F = G.useCallback(function(V, L = !1) {
        ...
        return t(() => {
          var $;
          ($ = C.current) == null || $.unsubscribe(), C.current = H = S(v(V, {
      ...
      const {
        select: m
      } = e.endpoints[h], v = Qn(l ? Te : s, P, g.endpointDefinitions[h], h), S = G.useRef(), A = G.useMemo(() => _([m(v), (F, V) => V, (F) => v], w, {
        memoizeOptions: {
          resultEqualityCheck: Ke
        }
      }), [m, v]), D = G.useMemo(() => u ? _([A], u, {
        devModeChecks: {
  ...
  function p(h) {
    return ({
      ...
      const {
        select: b,
        initiate: s
      } = e.endpoints[h], l = n(), [u, m] = G.useState();
      G.useEffect(() => () => {
      ...
      const v = G.useCallback(function(I) {
        ...
        t(() => {
          u && m(void 0), E && l(e.internalActions.removeMutationResult({
            requestId: S,
            fixedCacheKey: E
          }));
        });
...
GROUP BY ?contributor ?name ?hex_color_code ?emoji ?orcid ?orcid_profile ?untyped_identifier ?contributor_type_label ?user_graph`, Ac = (e) => `
...
`, ic = () => [
  ...
  "crm:P2_has_type",
  "rdf:type"
].join(" "), Dc = (e, t = !1, n = !1, o = !1, i = "", f = "OUTGOING") => t ? lc(
  e,
  o,
  i,
  f
...
WHERE {
  GRAPH ?lr_graph {
    ...
    }`, wr = (e, t, n, o, i) => `  UNION
    {
      VALUES ${t} { ${ac()} }
      ${Sr(e, t, n, i)}
      GRAPH ${n}_types_graph { 
        VALUES ${n}_type { ${sc()} }
        ${n} rdf:type ${n}_type .
        ${n} crm:P190_has_symbolic_content ${o} .
      }
      OPTIONAL {
        GRAPH ${n}_types_types_graph {
          ${n} crm:P2_has_type ${n}_type_type .
          GRAPH ${n}_types_types_label_graph {
            ${n}_type_type crm:P1_is_identified_by ${n}_type_type_label .
          }
        }
      }
    }`, bo = (e, t) => `  UNION
  ...
  let i = `${e} ${t} ${n} .`;
  return o && (i += dc(e, t, n, o)), i;
}, fc = (e, t, n) => {
  if (n === "INCOMING")
    return `?lr ${t} ${e}`;
  if (n === "OUTGOING")
    return `${e} ${t} ?lr`;
}, Oo = () => `PREFIX crm: <http://www.cidoc-crm.org/cidoc-crm/>
PREFIX dcterms: <http://purl.org/dc/terms/>
PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>
PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>
PREFIX skos: <http://www.w3.org/2004/02/skos/core#>
...
PREFIX crm: <http://www.cidoc-crm.org/cidoc-crm/>
SELECT * FROM <http://data-iremus.huma-num.fr/graph/sherlock>
WHERE { <${e}> crm:P140_assigned_attribute_to ?p140 }`, Fc = () => `
...
`;
export {
  _c as ANALYTICAL_ENTITY,
  Ii as ANALYTICAL_PROJECT,
  vc as ANNOTATION,
  Ci as DRAFT_PROJECT,
  pc as NOTE,
  mc as POSITIONNED_NOTE,
  gc as SCORE,
  hc as SELECTION,
  bc as SOFTWARE,
  yc as VERTICALITY,
  Rc as contributions,
  Nc as contributors,
  Ac as countLinkingPredicates,
  Ic as documentsByIndex,
  Cc as fondamentales,
  Ec as getAnalyticalProject,
  Oc as getAnnotations,
  Tc as getContributor,
  qc as getP140,
  kc as getResources,
  jc as historicalModelsOntologies,
  Dc as identity,
  xc as mg_livraisons,
  $c as noteOccurences,
  Lc as p127,
